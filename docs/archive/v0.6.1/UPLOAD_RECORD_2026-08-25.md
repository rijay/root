...
最新 0.6.1 热修复代码已上传并提交微信审核；当前未正式发布，也未推送 Git 远端。

## 审核提交

- 提交方式：项目负责人在微信公众平台手动提交；
- 平台回读状态：`审核中`；
- 平台显示版本：`0.6.1`；
- 提交审核时间：2026-08-25 17:32:20 CST；
- 回读时间：2026-08-25 17:32 CST；
- 回读证据：`/private/tmp/myroot-v061-review-submitted-readback-20260825.png`；
- 线上版本仍为 `0.6.0`，审核通过不等于正式发布，正式发布需要单独执行。
