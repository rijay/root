...
export const ADMIN_CAPABILITIES = Object.freeze({
  ...
  USER_LABEL_READ: "USER_LABEL_READ",
  USER_LABEL_HEALTH_READ: "USER_LABEL_HEALTH_READ",
  USER_LABEL_EXPORT: "USER_LABEL_EXPORT",
});
...
const CAPABILITY_LABELS = Object.freeze({
  ...
  [ADMIN_CAPABILITIES.USER_LABEL_READ]: "用户标签读取",
  [ADMIN_CAPABILITIES.USER_LABEL_HEALTH_READ]: "个人健康标签读取",
  [ADMIN_CAPABILITIES.USER_LABEL_EXPORT]: "用户标签飞书同步",
});
