...
test("admin operational analytics aggregates lifecycle funnel and bottlenecks", async () => {
  ...
  const couponGrant = store.rewardGrants.find((grant) => grant.reward_grant_id === couponJob.reward_grant_id);
  couponJob.status = "DELIVERED";
  couponJob.external_ref = "YZ_ANALYTICS_COUPON";
  couponJob.delivered_at = "2026-06-26T12:02:00+08:00";
  couponGrant.status = "DELIVERED";
  couponGrant.external_ref = "YZ_ANALYTICS_COUPON";
  couponGrant.delivered_at = "2026-06-26T12:02:00+08:00";
