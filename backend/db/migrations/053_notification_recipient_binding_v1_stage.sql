-- Freeze the exact MYROOT identity on each v1 subscription grant. The OpenID
-- is not duplicated; a keyed digest binds its current value to the durable
-- grant. This migration owns exactly one permanent ALTER because MySQL DDL
-- implicitly commits.

ALTER TABLE notification_subscription_grant_v1
  ADD COLUMN recipient_binding_status VARCHAR(16)
    CHARACTER SET ascii COLLATE ascii_bin NULL
    AFTER review_required_at,
