    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "健康建议仅作日常健康管理参考；评测分类、安全分流和建议内容均经过规则与内容审核。",
        ],
      },
      {
        title: "三、活动规则",
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        title: "三、健康建议",
        items: [
          "健康建议采用预先生成并经人工审核的通用建议目录。内容制作只使用产品团队定义的合成状态场景，不使用任何真实用户的身份、问卷答案、评测结果、健康状态或请求日志。",
          "你使用小程序时，myRoot 服务端仅按评测结果在本地目录中匹配建议。目录缺失、未完整审核或内容无效时自动改用经审核固定建议；安全提示分支始终使用经审核的安全文案。",
        ],
      },
      {
        title: "四、你的选择与权利",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "健康建议目录匹配：仅在 myRoot 服务端使用评测结果代码选择经审核建议；不对外提供用户身份、联系方式、评测结果、原始问卷答案或自由文本。",
