  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        title: "三、模型辅助建议",
        items: [
          "仅在两项评测均完成且未进入安全提示分支时，模型辅助功能才会调用腾讯云 CloudBase AI。发送范围限于评测类型、问卷版本、结果代码和状态标题；不发送姓名、手机号、微信身份标识、安全分流标记、原始问卷答案或自由文本。",
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          "模型辅助建议结构化状态：仅包含评测类型、问卷版本、结果代码和状态标题；不包含用户身份、联系方式、安全分流标记、原始问卷答案或自由文本。",
