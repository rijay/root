...
matches(profileWxss, /profile-identity\s*\{[^}]*top:\s*130px[^}]*width:\s*350px[^}]*height:\s*72px/s, "身份区坐标");
...
matches(privacyWxss, /cancellation-sheet\s*\{[^}]*top:\s*248px[^}]*height:\s*596px/s, "MY-06 确认弹层坐标");
